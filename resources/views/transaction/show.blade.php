...
<div class="container">
    ...
    <a type="button" href="/" class="btn btn-primary float-right">Kembali</a>
    <a type="button" href="/transaction/print/{{ request()->segment(2) }}" class="btn btn-dark float-right mr-2"
